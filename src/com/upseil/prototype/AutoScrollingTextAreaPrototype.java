...
public class AutoScrollingTextAreaPrototype extends ApplicationAdapter {
    Stage stage;
    int lineCounter;
    ...
    public void create () {
        ...
        final TextArea textArea = new TextArea("Initial line.\n"
                // Adding long text for soft line breaks
                + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
                + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
                + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
                + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. "
                + "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.", skin) {
...
//                float prefHeight = (getLines() + 1) * getStyle().font.getLineHeight(); // Work around
    ...
    public static void main (String[] args) throws Exception {
        ...
        config.width = 1024;
        config.height = 768;
        new LwjglApplication(new AutoScrollingTextAreaPrototype(), config);
    }
